...
public class AnimalController {
    ...
    public List<AnimalResponse> getAllByCustomerName(@PathVariable("customerName") String customerName) {
        return this.animalService.getAllByCustomerName(customerName);
    }
